...
import { ApplyTemplateCommand } from 'src/Application/Commands/ApplyTemplateCommand';
import { TestContext } from '../../TestContext';
import { LlmPort } from 'src/Domain/Ports/LlmPort';
import { ImageSearchPort } from 'src/Domain/Ports/ImageSearchPort';
import { UnresolvedLinkGeneratorSettings } from 'src/settings';
import { GenericFuzzySuggestModal } from 'src/Application/Views/GenericFuzzySuggestModal';
import { TemplateMatch } from 'src/Application/Utils/TemplateConfig';

// Mock GenericFuzzySuggestModal
jest.mock('src/Application/Views/GenericFuzzySuggestModal', () => {
    return {
