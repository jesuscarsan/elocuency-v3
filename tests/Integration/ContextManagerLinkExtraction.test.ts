...
import { ContextManager } from '../../src/Infrastructure/Obsidian/Views/LiveSession/Services/ContextManager';
...
describe('ContextManager Integration Test - Link Extraction', () => {
    ...
    beforeEach(() => {
        ...
        contextManager = new ContextManager(app);
    });
...
[[Present simple#Present simple, Positiva-Negativa]] y [[Hobbies]]`;
        ...
        // Act
        const result = await contextManager.getLinkedFileContent(sourceFile, range);
