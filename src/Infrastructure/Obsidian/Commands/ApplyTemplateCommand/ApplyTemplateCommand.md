...
4.  **Imágenes (Opcional)**: Si tras el proceso el campo `Imagenes urls` está vacío, busca imágenes automáticamente (similar a [Add Images Command](../AddImages/AddImagesCommand.md)).
