...
var require_GoogleGeminiAdapter = __commonJS({
  "../../libs/core-ts/dist/Adapters/GoogleGeminiAdapter/GoogleGeminiAdapter.js"(exports) {
    ...
    exports.GoogleGeminiAdapter = GoogleGeminiAdapter;
  }
});
...
var require_GoogleGeminiImagesAdapter = __commonJS({
  "../../libs/core-ts/dist/Adapters/GoogleGeminiAdapter/GoogleGeminiImagesAdapter.js"(exports) {
    ...
    var GoogleGeminiImagesAdapter = class {
      constructor(apiKey) {
        this.client = null;
        this.apiKey = apiKey.trim();
      }
...
var require_GoogleGeminiChatAdapter = __commonJS({
  "../../libs/core-ts/dist/Adapters/GoogleGeminiLiveAdapter/GoogleGeminiChatAdapter.js"(exports) {
    ...
    var genai_1 = (init_web(), __toCommonJS(web_exports));
    var GoogleGeminiChatAdapter = class {
...
var require_CommandIds = __commonJS({
  "../../libs/core-ts/dist/Domain/Constants/CommandIds.js"(exports) {
    ...
    var CommandEnum2;
    (function(CommandEnum3) {
      CommandEnum3["ApplyTemplate"] = "ApplyTemplateCommand";
      CommandEnum3["ApplyTemplateWithUrl"] = "ApplyTemplateWithUrlCommand";
      CommandEnum3["ApplyStreamBrief"] = "ApplyStreamBriefCommand";
      CommandEnum3["EnhanceByAi"] = "EnhanceByAiCommand";
      CommandEnum3["AddImages"] = "AddImagesCommand";
      CommandEnum3["CreateNoteFromImages"] = "CreateNoteFromImagesCommand";
      CommandEnum3["ApplyTemplateFromImage"] = "ApplyTemplateFromImageCommand";
      CommandEnum3["GenerateHeaderMetadata"] = "generate-header-metadata";
      CommandEnum3["RelocateNoteByLinkField"] = "RelocateNoteByLinkFieldCommand";
      CommandEnum3["GenerateMissingNotesFromLinks"] = "GenerateMissingNotesFromLinksCommand";
      CommandEnum3["CreateReciprocityLinksNotes"] = "CreateReciprocityLinksNotesCommand";
      CommandEnum3["AnalyzeAndLinkEntities"] = "AnalyzeAndLinkEntitiesCommand";
      CommandEnum3["GenerateMissingNotesFromListField"] = "GenerateMissingNotesFromListFieldCommand";
      CommandEnum3["EnrichPlace"] = "EnrichPlaceCommand";
      CommandEnum3["RelocatePlaceNote"] = "RelocatePlaceNoteCommand";
      CommandEnum3["AddPlaceIdFromUrl"] = "AddPlaceIdFromUrlCommand";
      CommandEnum3["SearchSpotifyTrack"] = "SearchSpotifyTrack";
      CommandEnum3["ImportPlaylistTracks"] = "ImportPlaylistTracks";
      CommandEnum3["SearchSpotifyArtist"] = "SearchSpotifyArtistCommand";
      CommandEnum3["InsertLinkToSelectedPhoto"] = "InsertLinkToSelectedPhotoCommand";
      CommandEnum3["OpenLinkedPhoto"] = "OpenLinkedPhotoCommand";
      CommandEnum3["EnrichWithPromptUrl"] = "EnrichWithPromptUrlCommand";
      CommandEnum3["SyncContacts"] = "SyncContactsCommand";
      CommandEnum3["ToggleHideEmptyProperties"] = "ToggleHideEmptyProperties";
      CommandEnum3["TokenizeAndCreateDictionaryNotes"] = "TokenizeAndCreateDictionaryNotesCommand";
    })(CommandEnum2 || (exports.CommandEnum = CommandEnum2 = {}));
  }
});
...
__export(main_exports, {
  default: () => EloGoogleContactsPlugin
});
...
// src/Infrastructure/Obsidian/Commands/SyncContactsCommand.ts
...
// src/Infrastructure/Obsidian/Commands/SyncContactsCommand.ts
var SyncContactsCommand = class {
  constructor(app, bridge) {
    this.app = app;
    this.bridge = bridge;
    this.id = import_core.CommandEnum.SyncContacts;
  ...
  async execute(file) {
    ...
    if (!targetFile || !(targetFile instanceof import_obsidian2.TFile)) {
      new import_obsidian2.Notice("No hay ninguna nota activa.");
      return;
    }
    if (!this.isPersona(targetFile)) {
      new import_obsidian2.Notice("La nota activa no es una Persona (falta tag #Personas).");
      return;
    }
    const view = getActiveMarkdownView(this.app, targetFile);
    if (!view) {
      new import_obsidian2.Notice("No se pudo obtener la vista de la nota para activar el modo edici\xF3n.");
      return;
    }
    await executeInEditMode(view, async () => {
      new import_obsidian2.Notice(`Sincronizando contacto: ${targetFile.basename}...`);
      try {
        await this.syncFile(targetFile);
        new import_obsidian2.Notice(`Sincronizaci\xF3n completada para ${targetFile.basename}`);
      } catch (e) {
        console.error(`Error syncing ${targetFile.basename}:`, e);
        new import_obsidian2.Notice(`Error al sincronizar: ${e.message}`);
      }
    });
  }
  isPersona(file) {
  ...
  async syncFile(file) {
    ...
    const contactData = {
      name: finalName,
      phone: frontmatter[import_core2.FrontmatterKeys.Telefono],
      email: frontmatter[import_core2.FrontmatterKeys.Email],
      birthday: frontmatter[import_core2.FrontmatterKeys.Cumpleanos],
      id: frontmatter[import_core2.FrontmatterKeys.EloAppleContactId]
      ...
      try {
        ...
        if (candidates && candidates.length > 0) {
          ...
          if (selectedCandidate) {
            ...
            new import_obsidian2.Notice(`Enlazado a: ${selectedCandidate.name}`);
          } else {
            console.log(`[SyncCurrentContact] User cancelled or chose create new.`);
            new import_obsidian2.Notice(`Creando nuevo contacto: ${finalName}`);
          }
        }
      } catch (err) {
    ...
    try {
      ...
      await this.app.fileManager.processFrontMatter(file, (fm) => {
        if (syncedContact) {
          if (syncedContact.id) {
            fm[import_core2.FrontmatterKeys.EloAppleContactId] = syncedContact.id;
          }
          if (!fm[import_core2.FrontmatterKeys.Telefono] && syncedContact.phones && syncedContact.phones.length > 0) {
            fm[import_core2.FrontmatterKeys.Telefono] = syncedContact.phones[0];
          }
          if (!fm[import_core2.FrontmatterKeys.Email] && syncedContact.emails && syncedContact.emails.length > 0) {
            fm[import_core2.FrontmatterKeys.Email] = syncedContact.emails[0];
          }
          if (!fm[import_core2.FrontmatterKeys.Cumpleanos] && syncedContact.birthday) {
            fm[import_core2.FrontmatterKeys.Cumpleanos] = syncedContact.birthday;
          }
        }
      });
    } catch (err) {
...
var ContactSelectionModal = class extends import_obsidian2.FuzzySuggestModal {
...
// src/Infrastructure/Obsidian/Commands/SyncGoogleContactsCommand.ts
var import_obsidian7 = require("obsidian");

// src/Infrastructure/Obsidian/Views/GoogleAuthModal.ts
...
// src/Infrastructure/Obsidian/Views/GoogleAuthModal.ts
var GoogleAuthModal = class extends import_obsidian4.Modal {
  ...
  onOpen() {
    ...
    new import_obsidian4.Setting(step1).addButton((btn) => btn.setButtonText("Connect Google").setCta().onClick(async () => {
    ...
    let code = "";
    new import_obsidian4.Setting(step2).setName("Authorization Code").setDesc("Paste the code or the full redirect URL here.").addText((text) => text.setPlaceholder("Paste code or URL...").onChange((value) => {
      code = value.trim();
      try {
    ...
    new import_obsidian4.Setting(contentEl).addButton((btn) => btn.setButtonText("Verify & Connect").setCta().onClick(async () => {
      if (!code) {
...
// src/Infrastructure/Adapters/GoogleContactAdapter.ts
...
var GoogleContactAdapter = class {
  ...
  async getAccessToken() {
    ...
    try {
      ...
      console.error("[GoogleAdapter] Auth Error", error);
      new import_obsidian5.Notice("Error al autenticar con Google. Revisa la consola.");
      throw error;
    }
  }
  async request(url, method = "GET", body) {
    ...
    const response = await (0, import_obsidian5.requestUrl)(params);
...
// src/Application/Services/GoogleContactSyncService.ts
...
var GoogleContactSyncService = class {
    ...
    if (!contactData.id) {
      ...
      try {
        ...
        if (candidates && candidates.length > 0) {
          ...
          if (selectedCandidate) {
            contactData.id = selectedCandidate.id;
            new import_obsidian6.Notice(`Enlazado a Google Contact: ${selectedCandidate.name}`);
          } else {
            new import_obsidian6.Notice(`Creando nuevo contacto en Google: ${cleanName}`);
          }
        } else {
          new import_obsidian6.Notice(`No se encontraron candidatos. Creando nuevo...`);
        }
      } catch (err) {
        console.error("Error searching candidate:", err);
      }
  ...
  async linkContactToNote(contact, file) {
    ...
    new import_obsidian6.Notice(`Enlazado: ${contact.name} <-> ${file.basename}`);
  }
  /**
...
var ContactSelectionModal2 = class extends import_obsidian6.FuzzySuggestModal {
  constructor(app, noteName, query, candidates, onChoose) {
    super(app);
    this.noteName = noteName;
    this.query = query;
...
// src/Infrastructure/Transformers/GoogleContactTransformer.ts
...
var _GoogleContactTransformer = class _GoogleContactTransformer {
  ...
  updateFrontmatterFromContact(frontmatter, contact) {
    ...
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Telefono, contact.phone);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Email, contact.email);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Cumpleanos, contact.birthday);
    this.updateFieldIfMissing(frontmatter, "aliases", contact.nickname ? [contact.nickname] : void 0);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Puesto, contact.jobTitle);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Empresa, contact.organization);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Direcciones, contact.addresses);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Urls, contact.urls);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Eventos, contact.events);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Relaciones, contact.relations);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Genero, contact.gender);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Ocupaciones, contact.occupations);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Intereses, contact.interests);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Habilidades, contact.skills);
    this.updateFieldIfMissing(frontmatter, import_core3.FrontmatterKeys.Residencias, contact.residences);
    if (contact.customFields) {
  ...
  toContact(file, frontmatter, allFileTags) {
    ...
    return {
      ...
      phone: this.clean(this.toArray(frontmatter[import_core3.FrontmatterKeys.Telefono])),
      email: this.clean(this.toArray(frontmatter[import_core3.FrontmatterKeys.Email])),
      birthday: this.clean(frontmatter[import_core3.FrontmatterKeys.Cumpleanos]),
      nickname: this.getStringFromCleaned(this.clean(frontmatter["aliases"])),
      jobTitle: this.clean(frontmatter[import_core3.FrontmatterKeys.Puesto]),
      organization: this.clean(frontmatter[import_core3.FrontmatterKeys.Empresa]),
      customFields: {
        eloSyncDate: (/* @__PURE__ */ new Date()).toISOString()
      },
...
var SyncGoogleContactsCommand = class {
  ...
  async execute(file) {
    ...
    if (!targetFile || !(targetFile instanceof import_obsidian7.TFile)) {
      new import_obsidian7.Notice("No hay ninguna nota activa.");
      return;
    }
    if (!this.isPersona(targetFile)) {
      new import_obsidian7.Notice("La nota activa no es una Persona (falta tag #Personas).");
      return;
    }
    const view = getActiveMarkdownView(this.app, targetFile);
    if (!view) {
      new import_obsidian7.Notice("No se pudo obtener la vista de la nota para activar el modo edici\xF3n.");
      return;
    }
    await executeInEditMode(view, async () => {
      new import_obsidian7.Notice(`Sincronizando con Google: ${targetFile.basename}...`);
      try {
        await this.service.syncNoteWithGoogle(targetFile);
        new import_obsidian7.Notice(`Sincronizaci\xF3n con Google completada para ${targetFile.basename}`);
      } catch (e) {
        console.error(`Error syncing ${targetFile.basename}:`, e);
        const msg = e.message;
        if (msg.includes("Refresh Token is missing") || msg.includes("No Google tokens") || msg.includes("401") || msg.includes("403") || msg.includes("invalid_grant") || msg.includes("Token has been expired")) {
          new import_obsidian7.Notice("Autenticaci\xF3n necesaria con Google.");
          new GoogleAuthModal(this.app, this.adapter, async () => {
            new import_obsidian7.Notice("Autenticado correctamente. Ejecuta el comando de nuevo.");
          }).open();
        } else {
          new import_obsidian7.Notice(`Error al sincronizar con Google: ${msg}`);
        }
      }
    });
  }
...
// src/Infrastructure/Obsidian/Commands/ProcessUnsyncedGoogleContactsCommand.ts
...
var ProcessUnsyncedGoogleContactsCommand = class {
  ...
  async execute() {
    new import_obsidian8.Notice("Buscando contactos no sincronizados en Google...");
    try {
      const matches = await this.fetchUnsyncedContacts();
      if (matches.length === 0) {
        new import_obsidian8.Notice("No se encontraron contactos pendientes de sincronizar.");
        return;
      }
...
var UnsyncedContactsBatchModal = class extends import_obsidian8.Modal {
  ...
  renderContactItem(container, match) {
    ...
    new import_obsidian8.ButtonComponent(actionsDiv).setButtonText(match.suggestedNote ? "Enlazar" : "Enlazar...").setIcon("link").setTooltip(match.suggestedNote ? `Enlazar con ${match.suggestedNote.basename}` : "Buscar nota para enlazar").onClick(async () => {
      if (match.suggestedNote) {
    ...
    new import_obsidian8.ButtonComponent(actionsDiv).setButtonText("Crear").setIcon("file-plus").setCta().setTooltip("Crear nueva nota en Personas/Conocidos-mios").onClick(async () => {
      const newFile = await this.service.createNoteFromContact(match.contact);
      new import_obsidian8.Notice(`Nota creada: ${newFile.basename}`);
      itemDiv.remove();
    });
    new import_obsidian8.ButtonComponent(actionsDiv).setButtonText("Mover").setIcon("import").setTooltip("Crear nota y eliminar de Google").onClick(async () => {
      if (confirm(`\xBFCrear nota para "${match.contact.name}" y eliminarlo de Google?`)) {
        ...
        if (match.contact.id) {
          ...
          new import_obsidian8.Notice(`Movido a Obsidian: ${match.contact.name}`);
        }
        itemDiv.remove();
      }
    });
    new import_obsidian8.ButtonComponent(actionsDiv).setButtonText("Eliminar").setIcon("trash").setWarning().setTooltip("Eliminar de Google Contacts").onClick(async () => {
      if (confirm(`\xBFSeguro que quieres eliminar a "${match.contact.name}" de Google Contacts?`)) {
        if (match.contact.id) {
          await this.adapter.deleteContact(match.contact.id);
          new import_obsidian8.Notice(`Eliminado de Google: ${match.contact.name}`);
        }
        itemDiv.remove();
      }
    });
...
var NoteSelectionModal = class extends import_obsidian8.FuzzySuggestModal {
...
// src/Infrastructure/Adapters/BridgeService.ts
...
var BridgeService = class {
  ...
  async startBridge(force = false) {
    ...
    try {
      this.photosBridgeProcess = (0, import_child_process.spawn)(executable, [], {
        detached: false,
...
// src/Infrastructure/Obsidian/Views/SettingsView.ts
var import_obsidian9 = require("obsidian");
var SettingsView = class extends import_obsidian9.PluginSettingTab {
  constructor(app, plugin) {
    super(app, plugin);
    this.plugin = plugin;
  }
  display() {
    ...
    new import_obsidian9.Setting(containerEl).setName("Google Client ID").setDesc("OAuth 2.0 Client ID").addText((text) => text.setPlaceholder("Enter your Client ID").setValue(this.plugin.settings.googleClientId).onChange(async (value) => {
      this.plugin.settings.googleClientId = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian9.Setting(containerEl).setName("Google Client Secret").setDesc("OAuth 2.0 Client Secret").addText((text) => text.setPlaceholder("Enter your Client Secret").setValue(this.plugin.settings.googleClientSecret).onChange(async (value) => {
      this.plugin.settings.googleClientSecret = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian9.Setting(containerEl).setName("Photos Bridge Path").setDesc("Path to the elo-mac-bridge executable").addText((text) => text.setPlaceholder("/path/to/photos-bridge").setValue(this.plugin.settings.photosBridgePath).onChange(async (value) => {
      this.plugin.settings.photosBridgePath = value;
      await this.plugin.saveSettings();
    }));
    new import_obsidian9.Setting(containerEl).setName("Auto-start Bridge").setDesc("Automatically start the Mac Bridge on plugin load").addToggle((toggle) => toggle.setValue(this.plugin.settings.autoStartBridge).onChange(async (value) => {
...
// src/Infrastructure/Obsidian/main.ts
var EloGoogleContactsPlugin = class extends import_obsidian10.Plugin {
  constructor() {
    super(...arguments);
  ...
  async onload() {
    ...
    if (import_obsidian10.Platform.isDesktop && this.settings.autoStartBridge) {
