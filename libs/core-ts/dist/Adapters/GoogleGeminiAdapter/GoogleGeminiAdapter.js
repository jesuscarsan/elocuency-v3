...
class GoogleGeminiAdapter {
    ...
    async requestEnrichment(params) {
        ...
        // ...
        const rawText = await this.generate(prompt, GEMINI_JSON_GENERATION_CONFIG, 'completar la plantilla automáticamente');
        if (!rawText)
            return null;
        ...
        const body = typeof parsedRecord.body === 'string'
